...
namespace CourseManagement.Repository.Migrations
{
    ...
    [Migration("20250105214458_AddCart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseManagement.Core.Entities.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseManagement.Core.Entities.ShoppingCartCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseManagement.Core.Entities.ShoppingCart", b =>
                {
                    b.HasOne("CourseManagement.Core.Entities.Student", "Student")
                        ...
                        .HasForeignKey("CourseManagement.Core.Entities.ShoppingCart", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CourseManagement.Core.Entities.ShoppingCartCourse", b =>
                {
                    ...
                    b.HasOne("CourseManagement.Core.Entities.ShoppingCart", "ShoppingCart")
                        .WithMany("ShoppingCartCourses")
            ...
            modelBuilder.Entity("CourseManagement.Core.Entities.ShoppingCart", b =>
                {
                    b.Navigation("ShoppingCartCourses");
                });
